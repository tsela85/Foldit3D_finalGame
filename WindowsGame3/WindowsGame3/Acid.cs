...
namespace Foldit3D
{
    class Acid
    {
        ...
        private void setVerts(Vector2 center)
        {
            ...
            Vector3 point1 = new Vector3(center.X - size, -0.025f, center.Y + size);
            Vector3 point2 = new Vector3(center.X + size, -0.025f, center.Y + size);
            Vector3 point3 = new Vector3(center.X + size, -0.025f, center.Y - size);
            Vector3 point4 = new Vector3(center.X - size, -0.025f, center.Y - size);
